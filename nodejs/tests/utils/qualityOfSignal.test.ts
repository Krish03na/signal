...
const poorSignal: Signal = {
    ...
    securityContext: {
        ...
        remediation: {
            ...
            impact: "If any of the external account is being used by subscriptions, then removing it will revoke its permissions. So, if there is a business requirement to allow an external account to use subscriptions then we should not remove it."
        },
        degreeOfImpact: 0,
        tags: {}
    }
